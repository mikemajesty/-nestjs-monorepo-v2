...
import { UserSearchInput, UserSearchOutput } from '@/core/user/use-cases/user-search';
...
export abstract class IUserSearchAdapter implements IUsecase {
  abstract execute(input: UserSearchInput): Promise<UserSearchOutput>;
}
